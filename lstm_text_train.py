...
FILE_NAME = "all_too_human.txt"
# MODEL_NAME = "model_human_256_200.h5"
MODEL_NAME = "model_human_most_recent.h5"
# CHECKPOINT_FILEPATH = "weights/human/weights.test.{epoch:02d}.hdf5"
CHECKPOINT_FILEPATH = "weights/human/weights.most_recent.{epoch:02d}.hdf5"
...
model = load_model("weights/human/weights.most_recent.94.hdf5")
...
def on_epoch_end(epoch, logs):
    ...
    f = open("training_logs.txt", "a", encoding="utf-8")
    print()
...
model.fit(x, y, batch_size=256, epochs=500, callbacks=callbacks)
